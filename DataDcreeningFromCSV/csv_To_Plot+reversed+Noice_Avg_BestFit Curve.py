...
# Load data
data = pd.read_csv('H:\Paper sensor with TANK\CODE FOR DATA SCREENING TEST\DATA\DATA03_newPaper.csv', encoding='latin1')
print(data.head())
...
noise = np.random.randint(-1500, 1200, size=len(data))
y2 =  reversed_y2 + noise
...
ax2.set_ylabel('Paper Sensor Value', fontsize=20, fontweight='bold', color='#FF7F50')
